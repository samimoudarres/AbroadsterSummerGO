-- Home feed: your own newest posts always surface above friends.
-- Soft-pin own posts from the last 6 hours so sharing lands at the top.
  ...
  from (
    select
      ...
      (
        ...
        -- Soft-pin: your own posts from the last 6h stay on top
        + case
            when p.author_id = me
